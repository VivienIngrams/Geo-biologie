        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col space-y-1.5 p-6">
              <h3 className="text-lg font-semibold leading-none tracking-tight">
                Harmonisation de l&apos;habitat
              </h3>
              <p className="text-sm text-muted-foreground">
                Pour un espace de vie équilibré
              </p>
            </div>
            <div className="flex-1 p-6 pt-0">
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                  <span>
                    Identification des sources d&apos;influence positives et
                    négatives
                  </span>
                </li>
                <li className="flex items-start gap-2">
          ...
          <div className="flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Identifier les sources de perturbation
              </p>
            </div>
            <div className="flex-1 p-6 pt-0">
              <ul className="space-y-2">
          ...
          <div className="flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Recherche d&apos;eau et d&apos;informations
              </p>
            </div>
            <div className="flex-1 p-6 pt-0">
              <ul className="space-y-2">
          ...
          <div className="flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Harmonisation pour les animaux
              </p>
            </div>
            <div className="flex-1 p-6 pt-0">
              <ul className="space-y-2">
          ...
          <div className='flex items-center justify-center w-full md:col-span-2 lg:col-span-3'>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                <p>
                  Nous échangeons par téléphone ou par email pour comprendre vos
                  besoins et définir le type d&apos;intervention nécessaire.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                <p>
                  Je me déplace sur le lieu concerné pour réaliser une analyse
                  complète et identifier les problématiques spécifiques.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                <p>
                  Je vous propose des solutions adaptées et assure un suivi pour
